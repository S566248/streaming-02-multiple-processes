...
INPUT_FILE_NAME = "Lottery_Powerball_Winning_Numbers__Beginning_2010.csv"
...
def prepare_message_from_row(row):
    ...
    ### reviewId, userName, content, score, thumbsUpCount, reviewCreatedVersion, at, appVersion = row
    Draw_Date, Winning_Numbers, Multiplier = row

    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    ### fstring_message = f"[{reviewId}, {userName}, {content}, {score}, {thumbsUpCount}, {reviewCreatedVersion}, {at}, {appVersion}]"
    fstring_message = f"[{Draw_Date}, {Winning_Numbers}, {Multiplier}]"
